 ...
 *
 * ⚠ `redFlags` AND `patterns` ARE NOT PILLAR DETAIL and stay on both shapes. They are the findings
 *   block, which every projection serves; dropping them here would have been the actual behaviour
 *   change this fork exists to avoid.
 */
