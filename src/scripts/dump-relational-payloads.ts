...
const obj = (findings: ObjectFinding[]): ObjectState => ({
  kind: "stock", stockId: "stk-acme", symbol: "ACME", displayLabel: "Acme Industries", isScored: true,
  coverage: { state: "scored", reason: null }, snapshot: { generation: "snap-acme-1", periodKey: "FY26Q1", composite: 71, band: "steady" },
...
const held = (attn: ReaderContext["attention"]): ReaderContext => ({
  ...
  watchlist: { exists: false, count: 0, thisAddedAt: null }, attention: attn,
});
const stranger = (): ReaderContext => ({
  ...
  watchlist: { exists: false, count: 0, thisAddedAt: null }, attention: { hasHistory: false, firstViewedAt: null, lastViewedAt: null, viewCount: 0, viewCountTrailing30d: 0, lastViewedSnapshotGeneration: null },
});
